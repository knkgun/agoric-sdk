...
# "packages/run-protocol/src/vaultFactory.js", and emit an abbreviation
...
abbreviations = {
    "packages/run-protocol/src/vaultFactory.js": "vaultFactory",
    "packages/pegasus/src/pegasus.js": "pegasus",
    "packages/zoe/src/contracts/multipoolAutoswap/multipoolAutoswap.js": "amm",
    "packages/run-protocol/src/liquidateMinimum.js": "liquidate",
    }
